<template>
  ...
  >
    ...
    <!-- Expanded Content with Side-by-Side Layout -->
    <transition name="expand">
      <div v-if="isExpanded" class="bubble-content-wrapper" @mousedown.stop @touchstart.stop>
        ...
        <div class="right-panel">
              ...
              <div class="session-list" v-if="sessions.length > 0">
                ...
                >
                  <div class="session-main">
                    <div class="session-status" :style="{ backgroundColor: getStatusColor(session.status) }">
                    ...
                    <div class="session-info">
                      ...
                      <div class="session-duration">
                        <strong>Thời gian:</strong> {{ formatDuration(session.elapsedTime) }} / {{ formatDuration(session.plannedDuration) }}
                      </div>
          ...
          </div> <!-- end pomodoro-content -->
        </div> <!-- end right-panel -->
      </div> <!-- end bubble-content-wrapper -->
    </transition>
  </div>
</template>
  ...
  try {
    ...
    const playChirp = (startTime, baseFreq, duration, pattern = 'up') => {
      ...
      if (pattern === 'up') {
        ...
        oscillator.frequency.exponentialRampToValueAtTime(baseFreq * 1.8, startTime + duration * 0.4)
        ...
        oscillator.frequency.setValueAtTime(baseFreq, startTime)
        oscillator.frequency.exponentialRampToValueAtTime(baseFreq * 1.4, startTime + duration * 0.3)
        oscillator.frequency.exponentialRampToValueAtTime(baseFreq * 1.2, startTime + duration * 0.6)
